...
for name in os.listdir('D:/the_data/new_data_tidu'): 
    ...
    aframe = {'lat':our_weidu,'lng':our_jingdu,'atidu_abs':atidu_abs,'direction_angle':direction_angle,'acc_state':acc_state,'location_time':location_time,'mileage':mileage}
